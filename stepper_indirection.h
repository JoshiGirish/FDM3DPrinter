...
// X motor
#define SET_A_X digitalWrite(X_a_pin,HIGH)
#define SET_B_X digitalWrite(X_b_pin,HIGH)
#define SET_C_X digitalWrite(X_c_pin,HIGH)
#define SET_D_X digitalWrite(X_d_pin,HIGH)
#define RESET_A_X digitalWrite(X_a_pin,LOW)
#define RESET_B_X digitalWrite(X_b_pin,LOW)
#define RESET_C_X digitalWrite(X_c_pin,LOW)
#define RESET_D_X digitalWrite(X_d_pin,LOW)
...
#define SET_A_Y digitalWrite(Y_a_pin,HIGH)
#define SET_B_Y digitalWrite(Y_b_pin,HIGH)
#define SET_C_Y digitalWrite(Y_c_pin,HIGH)
#define SET_D_Y digitalWrite(Y_d_pin,HIGH)
#define RESET_A_Y digitalWrite(Y_a_pin,LOW)
#define RESET_B_Y digitalWrite(Y_b_pin,LOW)
#define RESET_C_Y digitalWrite(Y_c_pin,LOW)
#define RESET_D_Y digitalWrite(Y_d_pin,LOW)
...
#define SET_A_Z digitalWrite(Z_a_pin,HIGH)
#define SET_B_Z digitalWrite(Z_b_pin,HIGH)
#define SET_C_Z digitalWrite(Z_c_pin,HIGH)
#define SET_D_Z digitalWrite(Z_d_pin,HIGH)
#define RESET_A_Z digitalWrite(Z_a_pin,LOW)
#define RESET_B_Z digitalWrite(Z_b_pin,LOW)
#define RESET_C_Z digitalWrite(Z_c_pin,LOW)
#define RESET_D_Z digitalWrite(Z_d_pin,LOW)
...
#define SET_A_E digitalWrite(E_a_pin,HIGH)
#define SET_B_E digitalWrite(E_b_pin,HIGH)
#define SET_C_E digitalWrite(E_c_pin,HIGH)
#define SET_D_E digitalWrite(E_d_pin,HIGH)
#define RESET_A_E digitalWrite(E_a_pin,LOW)
#define RESET_B_E digitalWrite(E_b_pin,LOW)
#define RESET_C_E digitalWrite(E_c_pin,LOW)
#define RESET_D_E digitalWrite(E_d_pin,LOW)
